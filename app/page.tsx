...
const sampleProperties = [
  {
    ...
    bedrooms: 3,
    area: '84.5㎡',
    image: 'data:image/svg+xml;base64,',
  ...
  },
  {
    ...
    bedrooms: 2,
    area: '59.2㎡',
    image: 'data:image/svg+xml;base64,',
  ...
  },
  {
    ...
    bedrooms: 4,
    area: '120.3㎡',
    image: 'data:image/svg+xml;base64,',
  ...
  },
  {
    ...
    bedrooms: 3,
    area: '76.8㎡',
    image: 'data:image/svg+xml;base64,',
...
export default function HomePage() {
    ...
    return allProperties.filter(property => {
      ...
      if (filters.area !== '전체') {
        ...
        if (filters.area.includes('~')) {
          ...
          // 평 단위인 경우 m²로 변환
          const minAreaM2 = filters.area.includes('평') ? minArea * 3.3 : minArea;
          const maxAreaM2 = filters.area.includes('평') ? maxArea * 3.3 : maxArea;
          
          if (areaNum < minAreaM2 || areaNum > maxAreaM2) return false;
        } else {
          // 기존 버튼 형식 처리
      ...
      if (filters.price !== '전체') {
        ...
        if (filters.price.includes('~')) {
          ...
          const minPrice = parseFloat(minStr.replace(/[억\s]/g, ''));
          const maxPrice = parseFloat(maxStr.replace(/[억\s]/g, ''));
      ...
      if (filters.deposit !== '전체') {
        // 매물에 보증금 정보가 있다면 필터링
        if (property.deposit) {
          const depositNum = parseFloat(property.deposit.replace(/[만원\s,]/g, ''));
          
          // 범위 형식 (예: "500만원~2000만원") 처리
          if (filters.deposit.includes('~')) {
            const [minStr, maxStr] = filters.deposit.split('~');
            const minDeposit = parseFloat(minStr.replace(/[만원\s]/g, ''));
            const maxDeposit = parseFloat(maxStr.replace(/[만원\s]/g, ''));
            
            if (depositNum < minDeposit || depositNum > maxDeposit) return false;
          } else {
            // 단일 값 처리
            const filterDeposit = parseFloat(filters.deposit.replace(/[만원\s]/g, ''));
            if (depositNum !== filterDeposit) return false;
          }
        } else {
          // 보증금 정보가 없는 매물은 필터에서 제외
          return false;
        }
      }
  ...
  const handleGeocodeResult = (address: string, lat: number, lng: number) => {
    ...
    const newProperty = {
      ...
      bedrooms: 0,
      area: '면적 미정',
      image: 'data:image/svg+xml;base64,',
  ...
  const handleBulkUploadedProperties = (properties: any[]) => {
    ...
    const enrichedProperties = properties.map(property => ({
      ...property,
      image: property.image || 'data:image/svg+xml;base64,',
